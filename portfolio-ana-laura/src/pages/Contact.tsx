    ...
    return (
        <section className="contact-section" id="contact">
            <div className="contact-left">
                <div className="contact-nav-overlay">
                    <span>2028</span>
                    <span>creative</span>
                </div>
                <img
            ...
            <div className="contact-right">
                ...
                <div className="contact-content">
                    <div className="contact-icons-row">
                        <a href="https://wa.me/5561993730804" target="_blank" rel="noopener noreferrer" className="contact-icon whatsapp">
                            <WhatsAppIcon />
                        </a>
                        <a href="https://www.instagram.com/lauracastro.fotografias/" target="_blank" rel="noopener noreferrer" className="contact-icon instagram">
                            <InstagramIcon />
                        </a>
                        <a href="mailto:seuemail@exemplo.com" className="contact-icon email">
                            <EmailIcon />
                        </a>
                    </div>
                ...
                <p className="contact-footer-text">VAMOS TRANSFORMAR A IDEIA EM VISUAL.</p>
            </div>
        </section>
    );
};